    ...
    <div class="container text-center">
        <div class="row">
            <form method="post" class="sign-in-form mt-5 mt-md-5 col-lg-4 col-md-5 col-sm-8">
                ...
                <input type="text" id="name" name="name" class="form-control mt-3" placeholder="Name" required="" autofocus="">
                ...
                <button class="w-75 btn btn-lg btn-primary mt-1" type="submit">Sign up</button>
            </form>
        </div>
    </div>
</body>